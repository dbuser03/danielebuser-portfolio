...
export const SECTION_STYLES = {
  ...
  educationList: "col-span-full grid grid-cols-1 gap-6 sm:col-span-10 sm:col-start-3 sm:grid-cols-2 md:col-span-8 lg:col-span-6",
  educationItem: "flex max-w-xs flex-col",
